...
import { delay, forkJoin, map, Observable, ObservableLike, ObservedValueOf, of, pipe, switchMap, tap } from 'rxjs';
...
export class ProductsService {
  ...
  createProduct(
    ...
    return this.uploadImages(imageFilelist).pipe(
      ...
      switchMap((createdProductLike) =>
      this.http.post<Product>(`${baseUrl}/products`, createdProductLike)
    ),
    tap((product) => this.updateProductCache(product))
    );
